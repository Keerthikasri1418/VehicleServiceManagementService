...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Tips</label>
	             <textarea name="Tips" id="" cols="30" rows="2" class="form-control summernote"><?php echo  is_file(base_app.'tip.html') ? file_get_contents(base_app.'tip.html') : "" ?></textarea>
			</div>
			<div class="form-group">
